...
export function GridTileImage({
  ...
  return (
    <>
      <div
        className={clsx(
          'relative h-fit w-fit flex-col items-center justify-center overflow-hidden',
          {
      ...
      >
        ...
        {props.src ? (
          <Image
            className={clsx('relative h-fit w-fit object-contain', {
      ...
      {labels ? (
        <div className="left-0 top-0 w-3/4 pt-3 text-black dark:text-white">
          <h3
            data-testid="product-name"
            className={clsx(
              'inline bg-white box-decoration-clone py-3 text-sm font-semibold leading-loose shadow-[1.25rem_0_0] shadow-white dark:bg-black dark:shadow-black',
          ...
          <Price
            className="w-fit bg-white py-3 text-sm dark:bg-black dark:text-white"
